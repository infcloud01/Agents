...
COMPARTMENT_ID = "ocid1.compartment.oc1.." # Enter your OCID here
ENDPOINT = "https://inference.generativeai.us-chicago-1.oci.oraclecloud.com" # Use the correct region for your tenancy and compartment

# --- 2. INITIALIZE OCI MODELS (COHERE) ---
embeddings = OCIGenAIEmbeddings(
    model_id="cohere.embed-english-v3.0", #Change if you want
    service_endpoint=ENDPOINT,
    compartment_id=COMPARTMENT_ID
)

llm = ChatOCIGenAI(
    model_id="cohere.command-r-08-2024", # Change if you want
    service_endpoint=ENDPOINT,
    compartment_id=COMPARTMENT_ID,
...
loader = PyPDFDirectoryLoader("./knowledge_base/") # Create the folder with the pdf's
docs = loader.load()
